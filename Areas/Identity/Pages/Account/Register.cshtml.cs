...
namespace StaffLogin.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // set the Coach role for the created user
                    await _userManager.AddToRoleAsync(user, "Coach"); // (await _userManager.FindByNameAsync(user.UserName), "Coach");
                    _logger.LogInformation($"User <{user.UserName}> created a new Coach account with password.");
